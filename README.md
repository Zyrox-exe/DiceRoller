...
1. Clone this Repository with:<br>`git clone https://github.com/Zyrox-exe/DiceRoller.git`.
2. Open in any modern browser like chrome, firefox etc.
3. Edit the source code as per your liking.
4. Deploy it using a service like github pages/ Vercel.

# Credits
The dice images used for 2-6 were by [Flaticon](https://www.flaticon.com/).<br>
The dice image for 1 belongs to [Freeiconspng](https://www.freeiconspng.com/).
